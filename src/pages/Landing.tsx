...
export default function Landing() {
  ...
  // Animated text component that cycles through key features
  function AnimatedText() {
    const phrases = ["Import Contacts", "Create Campaign", "Track & Optimize"];
    ...
    return <span className="animate-fade">{phrases[index]}</span>;
  }

  // Animated envelope component with optional delay for staggered animations
  function AnimatedEnvelope({ delay = "0s" }) {
    return (
      <svg
        className="absolute left-0 top-1/2 transform -translate-y-1/2 text-indigo-400 w-10 h-10 animate-slide-envelope"
    ...
    <>
      ...
      <style>{`
        ...
        .animate-slide-envelope {
          animation: slide-envelope 4s ease-in-out infinite;
        }
        @keyframes fade {
          0% { opacity: 0; }
          20% { opacity: 1; }
      ...
      `}</style>
      <div className="min-h-screen relative bg-gradient-to-b from-gray-900 to-gray-850 text-white overflow-hidden">
        {/* Decorative Background Element */}
        <div className="absolute top-[-100px] right-[-100px] w-96 h-96 bg-gradient-to-br from-indigo-500 to-transparent opacity-20 rounded-full animate-rotate-bg"></div>
        ...
        <section className="container mx-auto px-4 py-24 text-center relative z-10">
          ...
          {/* Enhanced Simulated Animations: Dual Animated Envelopes & Rotating Feature Text */}
          <div className="mt-12 relative h-20 w-full overflow-hidden">
            <AnimatedEnvelope delay="0s" />
            <AnimatedEnvelope delay="2s" />
          </div>
          <div className="mt-4 text-xl text-indigo-300">
            Effortless Automation with <AnimatedText />
          </div>
        ...
        {/* Stats Section */}
        <section className="container mx-auto px-4 py-16 border-t border-gray-700 relative z-10">
        ...
        {/* How It Works */}
        <section className="container mx-auto px-4 py-24 border-t border-gray-700 relative z-10">
          <div className="text-center mb-16">
        ...
        <section className="container mx-auto px-4 py-24 border-t border-gray-700 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <Card key={idx} className="p-8 hover:scale-105 transform transition duration-300">
        ...
        {/* Final CTA */}
        <section className="container mx-auto px-4 py-24 text-center border-t border-gray-700 relative z-10">
